...
module.exports = {
  ...
  HUGGINGFACE_CHAT_MODEL: readString('HUGGINGFACE_CHAT_MODEL', ''),
  HUGGINGFACE_VISION_MODEL: readString('HUGGINGFACE_VISION_MODEL', ''),
  ...
  LOADSTRING_API_BASE_URL: readString('LOADSTRING_API_BASE_URL', 'http://127.0.0.1:3006').replace(/\/+$/, ''),
  LOADSTRING_API_TOKEN: readString('LOADSTRING_API_TOKEN', ''),
  LOADSTRING_API_TIMEOUT_MS: readNumber('LOADSTRING_API_TIMEOUT_MS', 8_000, { min: 500 }),
  GROQ_KEY_QUEUE_BASE_URL: readString('GROQ_KEY_QUEUE_BASE_URL', readString('LOADSTRING_API_BASE_URL', 'http://127.0.0.1:3006')).replace(/\/+$/, ''),
  GROQ_KEY_QUEUE_TOKEN: readString('GROQ_KEY_QUEUE_TOKEN', readString('LOADSTRING_API_TOKEN', '')),
  GROQ_KEY_QUEUE_POLL_MS: readNumber('GROQ_KEY_QUEUE_POLL_MS', 120_000, { min: 5_000 }),
  HF_KEY_QUEUE_BASE_URL: readString('HF_KEY_QUEUE_BASE_URL', readString('GROQ_KEY_QUEUE_BASE_URL', readString('LOADSTRING_API_BASE_URL', 'http://127.0.0.1:3006'))).replace(/\/+$/, ''),
  HF_KEY_QUEUE_TOKEN: readString('HF_KEY_QUEUE_TOKEN', readString('GROQ_KEY_QUEUE_TOKEN', readString('LOADSTRING_API_TOKEN', ''))),
  HF_KEY_QUEUE_POLL_MS: readNumber('HF_KEY_QUEUE_POLL_MS', readNumber('GROQ_KEY_QUEUE_POLL_MS', 120_000, { min: 5_000 }), { min: 5_000 }),
  ...
  AI_RANDOM_CONTEXT_SCAN: readNumber('AI_RANDOM_CONTEXT_SCAN', 20, { min: 1 }),
  AI_RANDOM_CONTEXT_MIN_KEEP: readNumber('AI_RANDOM_CONTEXT_MIN_KEEP', 10, { min: 1 }),
  AI_RANDOM_CONTEXT_MAX_KEEP: readNumber('AI_RANDOM_CONTEXT_MAX_KEEP', 20, { min: 1 }),
